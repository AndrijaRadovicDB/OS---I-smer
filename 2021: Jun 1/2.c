// Program u detetu izvrsava stat fPath, i preusmerava izlaz u roditelja koji
// ispisuje prava pristupa i tipu fajla, ako stat ne uspe ispisati neuspeh
...
int main(int argc, char** argv){
    ...
    // Ovo moze i dole pa da se stavi check_error, mada, ako fajl ne postoji
    // getline ce svakako failovati
    char* line = NULL;
    size_t read_bytes = 0;
    int ret_val = getline(&line, &read_bytes, f);
