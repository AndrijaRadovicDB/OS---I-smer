// Program radi sa objektima deljene memorije. Program ceka na semaforu i onda
// kopira sve parne brojeve u niz i promeniti velicinu niz. Na kraju ispisati
// broj parnih brojeva.
#include <sys/stat.h>
#include <sys/types.h>
#include <fcntl.h>
