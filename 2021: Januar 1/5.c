// Program radi sa objektima deljene memorije. Zamenju sva mala slova niske
// velikim. Treba da saceka semafor, a nakod obrade da ga postavi.
#include <sys/stat.h>
#include <sys/types.h>
#include <fcntl.h>
#include <unistd.h>
...
void* OsGetMemBlock(char* fPath, int* size){
    ...
    *size = fInfo.st_size;
    ...
    void* addr;
    check_error((addr = mmap(NULL, *size, PROT_WRITE | PROT_READ, MAP_SHARED, memFd, 0)) != MAP_FAILED, "mmap");
