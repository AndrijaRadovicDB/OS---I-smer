// Program cita rec po rec i ako rec pocinje sa test_ pokusava da je zakljuc za
// pisanje, ako ne moze da je zakljuca prelazi na sledecu rec. Ako je uspesno
// zakljucana treba sve karaktere zameniti sa #.
